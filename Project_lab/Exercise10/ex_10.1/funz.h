...
public:
  ...
  double Mod_CostFunc(vector<double>, vector<double>);
};
...
public:
  ...
  void Metropolis(Individual &, double);	// Does a random search and overwrites individual with  
  double Boltzmann(Individual , double);	// probability proportional to the ratio of Boltzmann weightes
